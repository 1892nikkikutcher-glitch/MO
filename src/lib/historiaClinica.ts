...
export const plantillaInicial: HistoriaClinicaTemplate = {
  secciones: [
    ...
    },
    {
      ...
      preguntas: [
        { id: id("p"), tipo: "chips", etiqueta: "Ganglios (grupo 1)", opciones: ["Palpables", "No palpables", "Único", "Adherido", "Múltiple", "Móvil", "Sin datos patológicos aparentes"] },
      ...
      preguntas: [
        {
          ...
          tipo: "texto",
          etiqueta: "Labios",
          sugerencias: ["Sin datos patológicos aparentes", "Hipohidróticos", "Resecos", "Fisurados", "Queilitis angular", "Herpes labial", "Con lesión"],
        },
        {
          id: id("p"),
          tipo: "texto",
          etiqueta: "Lengua",
          sugerencias: ["Sin datos patológicos aparentes", "Saburral", "Geográfica", "Fisurada", "Atrófica", "Macroglosia", "Con lesión"],
        },
        {
          id: id("p"),
          tipo: "texto",
          etiqueta: "Región vestibular",
          sugerencias: ["Sin datos patológicos aparentes", "Frenillo corto", "Línea alba", "Hiperplasia", "Fístula", "Con lesión"],
        },
        {
          id: id("p"),
          tipo: "texto",
          etiqueta: "Tejidos blandos",
          sugerencias: ["Sin datos patológicos aparentes", "Gingivitis", "Hiperplasia gingival", "Pulpitis", "Absceso", "Úlcera", "Fístula"],
        },
        {
          id: id("p"),
          tipo: "texto",
          etiqueta: "Tejidos duros",
          sugerencias: ["Sin datos patológicos aparentes", "Caries", "Fractura dental", "Desgaste oclusal", "Hipoplasia del esmalte", "Movilidad dentaria"],
        },
      ],
    },
    {

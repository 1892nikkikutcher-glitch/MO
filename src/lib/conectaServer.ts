 ...
 * Nunca se usa desde el cliente. La parte sin dependencias de Firebase vive
 * en conectaServerPuro.ts (para poder probarla con Vitest puro) y se
 * reexporta aquí para que el resto del código no note la diferencia. */

import { dbAdmin } from "./firebaseAdmin";
import { evaluarRateLimit, type VentanaRateLimit } from "./rateLimitConecta";

export { ConectaError, nowISO, sinIndefinidos } from "./conectaServerPuro";

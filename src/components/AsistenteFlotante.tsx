  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-[62px] left-6 z-40 flex h-20 w-20 items-center justify-center rounded-full border border-accent/50 bg-accent/20 text-accent backdrop-blur transition-transform hover:scale-105 print:hidden"
      >
        <IconoAsistente />
      </button>
      ...
      {abierto && (
        <>
          <div
            ...
            aria-hidden
          />
          <div className="fixed bottom-[158px] left-6 z-50 max-h-[70vh] w-[calc(100vw-3rem)] max-w-sm overflow-y-auto rounded-2xl border border-edge/10 bg-modal-solid p-5 shadow-2xl print:hidden">
